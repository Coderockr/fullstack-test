...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API for managing investments: creation, compound-gain '
            .'valuation, age-based taxed withdrawals and per-owner listing. '
            .'Authenticate with a Bearer token from POST /api/login.',
    ],
